                            ...
                            <div class="modal-body">
                                <form id="tambahmasuk-form" enctype="multipart/form-data">
                                    ...
                                    @endauth --}}
                                        ...
                                        <select name="id_jenis_pemasukan" id="jenismasuk" class="form-select mb-3">
                                            <option selected value="">Pilih jenis pemasukan</option>
                                            @foreach ($jenis_masuk as $jpm)
                                    ...
                                    <tr idPemasukan="{{ $pmsk->id }}">
                                        ...
                                        <td col-2>
                                            <button type="button" class="editBtn btn btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#edit-modal-{{ $pmsk->id }}"
                                                idPemasukan="{{ $pmsk->id }}">
                                                Edit
                                            </button>
                                    ...
                                    <div class="modal fade" id="edit-modal-{{ $pmsk->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="edit-pemasukan-form-{{ $pmsk->id }}"
                                                   ...
                                                   @endauth --}}
                                                            ...
                                                            <select name="id_jenis_pemasukan" id="jenisPemasukan"
                                                                ...
                                                                @foreach ($jenis_masuk as $jpm)
                                                                    <option value="{{ $jpm->id }}"
                                                                        @if ($jpm->id === $pmsk->id_jenis_pemasukan) selected @endif>
                                                                        {{ $jpm->jenis_pemasukan }}</option>
                                                                @endforeach
                                                            </select>
                                                            <label>Tanggal Pemasukan</label>
                                                            <input type="datetime-local" name="tanggal_pemasukan"
                                                                id="tanggalPemasukan" class="form-control mb-3"
                                                                value="{{ $pmsk->tanggal_pemasukan }}">
                                                            <label>Jumlah Pemasukan</label>
                                                            <input type="number" name="jumlah_pemasukan" id="jumlahMasuk"
                                                                class="form-control mb-3"
                                                                value="{{ $pmsk->jumlah_pemasukan }}">
                                                            <label>Deskripsi</label>
                                                            <textarea name="deskripsi" class="form-control mb-3" rows="7" placeholder="Tulis ringkasan surat disini..."
