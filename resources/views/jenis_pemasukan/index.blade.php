    ...
    <div class="row justify-content-center ">
        <div class="col-md">
            ...
            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                    data-bs-target="#tambahjenismasuk-modal">Tambah</button>

                {{-- modaltambah --}}
                <div class="modal fade" id="tambahjenismasuk-modal" tabindex="-1"
               ...
               <div class="modal-dialog modal-dialog-centered">
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                        <form id="tambah-jenis-pemasukan-form">
                            <div class="form-group">
                                ...
                                <input placeholder="Donatur" type="text" class="form-control mb-3"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" form="tambah-jenis-pemasukan-form">Tambah</button>
                    </div>
                   </div>
               </div>
           </div>     
            ...
            <div class="card-body" style="width: 75vw">
                <table class="table table-bordered table-hovered DataTable" style="width: 72vw">
                    ...
                    @foreach($jenis_pemasukan as $jpm)
                        <tr idJS="{{$jpm->id}}">
                            <td class="col-1">{{$jpm->id}}</td>
                            <td>{{$jpm->jenis_pemasukan}}</td>
                            <td class="col-2">
                                <!-- Button trigger edit modal -->
                                <button type="button" class="editBtn btn btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#edit-modal-{{$jpm->id}}" idJS="{{$jpm->id}}">
                                    Edit
                                </button>
                      ...
                      <div class="modal fade" id="edit-modal-{{$jpm->id}}" tabindex="-1"
                             aria-labelledby="exampleModalLabel"
                             aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
...
<script type="module">
    ...
    $('#tambah-jenis-pemasukan-form').on('submit', function (e) {
            ...
            axios.post('/jenis_pemasukan/tambah', Object.fromEntries(data))
                .then(() => {
        ...
        $('.table').on('click', '.hapusBtn', function () {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete(`/jenis_pemasukan/${idJS}/hapus`)
        ...
        $('.editBtn').on('click', function (editBtn) {
            ...
            let idJS = $(this).closest('tr').attr('idJS');
            $(`#edit-jpm-form-${idJS}`).on('submit', function (e) {
                e.preventDefault();
                let data = Object.fromEntries(new FormData(e.target));
                axios.post(`/jenis_pemasukan/${idJS}/edit`, data)
                    .then(() => {
